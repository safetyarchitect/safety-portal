...
!function(a, b) {
	...
	function Yb(a, b, c, d) {
		...
		else if (c || null == b || "object" != typeof b) d(a, b);else
	...
	function $b(a, c) {
		a.dataFilter && (c = a.dataFilter(c, a.dataType));var g,
			h,
			j,
			l,
			m,
	...
	f.extend({
		...
		"removeData" : function(a, b, c) {
			if (f.acceptData(a)) {
				...
				if (h[i] && !(b && (d = c ? h[i][e] : h[i], d && (d[b] || (b = f.camelCase(b)),
					delete d[b]
					, !l(d))) || c && (
					delete h[i][e]
					, !l(h[i])))) {
					...
					f.support.deleteExpando || !h.setInterval ?
						delete h[i]
						: h[i] = null, j ? (h[i] = {}, g || (h[i].toJSON = f.noop), h[i][e] = j) : g && (f.support.deleteExpando ?
						delete a[f.expando]
						: a.removeAttribute ? a.removeAttribute(f.expando) : a[f.expando] = null)
				}
			}
		},
							...
							if (r = h, q = null, l = h.indexOf(".") < 0, m = [], l || (m = h.split("."), h = m.shift(), n = new RegExp("(^|\\.)" + f.map(m.slice(0).sort(), B).join("\\.(?:.*\\.)?") + "(\\.|$)")), p = t[h])
								if (d) {
									for (o = f.event.special[h] || {}, j = e || 0; j < p.length && (q = p[j], d.guid !== q.guid || ((l || n.test(q.namespace)) && (null == e && p.splice(j--, 1), o.remove && o.remove.call(a, q)), null == e)); j++)
										;
									(0 === p.length || null != e && 1 === p.length) && (o.teardown && o.teardown.call(a, m) !== !1 || f.removeEvent(a, h, s.handle), g = null,
									delete t[h]
									)
								} else
	...
	f.support.focusinBubbles || f.each({
		...
		f.fn[c] = function(a, d, e) {
			...
			if ((2 === arguments.length || d === !1) && (e = d, d = b), "one" === c ? (g = function(a) {
				...
				}, g.guid = e.guid || f.guid++) : g = e, "unload" === a && "one" !== c) this.one(a, d, e);else
	...
	try {
		...
		"ajax" : function(a, c) {
			function w(a, c, l, m) {
				if (2 !== s) {
					...
					if (a >= 200 && 300 > a || 304 === a)
						if (d.ifModified && ((y = v.getResponseHeader("Last-Modified")) && (f.lastModified[k] = y), (z = v.getResponseHeader("Etag")) && (f.etag[k] = z)), 304 === a) w = "notmodified", o = !0;else try {
			...
			if (t = d.global, d.type = d.type.toUpperCase(), d.hasContent = !Gb.test(d.type), t && 0 === f.active++ && f.event.trigger("ajaxStart"), !d.hasContent && (d.data && (d.url += (Ib.test(d.url) ? "&" : "?") + d.data,
				delete d.data
				), k = d.url, d.cache === !1)) {
				var x = f.now(),
					...
					c.mimeType && h.overrideMimeType && h.overrideMimeType(c.mimeType), c.crossDomain || e["X-Requested-With"] || (e["X-Requested-With"] = "XMLHttpRequest");try {
						...
						try {
							if (d && (e || 4 === h.readyState))
								if (d = b, i && (h.onreadystatechange = f.noop, bc &&
									delete dc[i]
									), e) 4 !== h.readyState && h.abort();else {
	...
	f.fn.extend({
		...
		"animate" : function(a, b, c, d) {
			...
			return f.isEmptyObject(a) ? this.each(e.complete, [ !1 ]) : (a = f.extend({}, a), this[e.queue === !1 ? "each" : "queue"](function() {
				...
				for (i in a) {
					if (g = f.camelCase(i), i !== g && (a[g] = a[i],
						delete a[i]
						), h = a[g], f.isArray(h) ? (b.animatedProperties[g] = h[1], h = a[g] = h[0]) : b.animatedProperties[g] = b.specialEasing && b.specialEasing[g] || b.easing || "swing", "hide" === h && d || "show" === h && !d) return b.complete.call(this);
