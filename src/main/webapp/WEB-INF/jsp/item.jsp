...
<link rel="stylesheet" type="text/css"
	href="/css/taotao.css" media="all" />
<link rel="stylesheet" type="text/css"
	href="/css/pshow.css" media="all" />
...
<body version="140120">
	...
	<div class="w">
		<div class="breadcrumb">
			...
			<span>
				<a href="http://www.baidu.com">长虹（CHANGHONG）</a>&nbsp;&gt;&nbsp;
				<a href="http://www.baidu.com">长虹LED42538ES</a>
			</span>
		</div>
	</div>
	<!--breadcrumb end-->
			...
			<div id="product-detail" class="m m1" data-widget="tabs"
				...
				<div class="mc" data-widget="tab-content" id="product-detail-1">
					<ul class="detail-list">
						...
						<li>商品编号：1221882</li>
						<li>品牌：<a href="http://www.baidu.com"
				...
				<div id="promises">
					...
					淘淘向您保证所售商品均为正品行货，淘淘自营商品开具机打发票或电子发票。凭质保证书及淘淘发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由淘淘联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。淘淘还为您提供具有竞争力的商品价格和<a
						href="http://www.baidu.com" target="_blank">运费政策</a>，请您放心购买！
					<br />
					<br />
	...
	<script type="text/javascript"
		src="/js/lib-v1.js"></script>
	<script type="text/javascript"
		src="/js/product.js"></script>
	<script type="text/javascript"
		src="/js/iplocation_server.js"></script>
	<script type="text/javascript">
		var itemControl = {
				param:{
						descUrl:"/item/desc/",
